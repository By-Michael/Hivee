...
import { Landmark, Mail, Lock, Eye, EyeOff, ShieldCheck, TrendingUp, Users } from 'lucide-react'
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-brand-gradient relative overflow-hidden px-12 py-10 text-white">
        ...
        <div className="relative flex items-center gap-3">
          <div className="h-11 w-11 rounded-2xl bg-white/15 backdrop-blur flex items-center justify-center ring-1 ring-white/30">
            <Landmark className="h-6 w-6" />
          </div>
          <span className="font-display font-bold text-xl">CFMS</span>
        </div>
      ...
      <div className="flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-sm animate-fade-up">
          <div className="lg:hidden flex items-center gap-2.5 mb-8">
            <div className="h-10 w-10 rounded-2xl bg-brand-gradient flex items-center justify-center shadow-glow">
              <Landmark className="h-5 w-5 text-white" />
            </div>
            <span className="font-display font-bold text-lg text-ink-900">CFMS</span>
          </div>
