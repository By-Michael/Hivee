    ...
    <div className="min-h-screen grid lg:grid-cols-2 login-page">
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-0.5">
          ...
          <span
            className="font-display font-extrabold text-xl -ml-1"
      ...
      <div className="flex items-center justify-center px-6 py-12 bg-white">
        <div className="w-full max-w-sm animate-fade-up">
          <div className="lg:hidden flex items-center gap-0.5 mb-8">
            ...
            <span className="font-display font-bold text-lg text-ink-900 -ml-1"><span className="text-amber-500">i</span>vee</span>
          </div>
